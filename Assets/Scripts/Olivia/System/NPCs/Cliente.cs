...
public class Cliente : MonoBehaviour, IInteractable
{
    ...
    public string dialogoGracias = "Gracias, Lucas. Dejala ah�.";
    ...
    [Tooltip("�Puede el cliente agarrar pedidos que colisionen con �l?")]
    ...
    void TomarPedido()
    {
        ...
        // El indicador violeta se queda encendido pero quiz�s podr�as cambiarle el color 
        // o dejarlo para que Lucas sepa que todav�a tiene algo pendiente aqu�.
    ...
    void EntregarPedido()
    {
        ...
        {
            Manager.Instance.MostrarDialogo("Lucas: Esto no es lo que me pidi�...");
        }
        else
        {
            Manager.Instance.MostrarDialogo("Lucas: Todav�a no tengo lo que me pidi�...");
        }
    }
